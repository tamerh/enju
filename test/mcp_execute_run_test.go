...
func TestMCPExecuteRunAllComputeCascades(t *testing.T) {
	eachRemoteMode(t, "ExecRunAll", func(t *testing.T, h *mcpHarness) {
		requireRemote(t, h)
...
func TestMCPExecuteRunStopsAtCitizenTask(t *testing.T) {
	eachRemoteMode(t, "ExecRunStopAtCitizen", func(t *testing.T, h *mcpHarness) {
		requireRemote(t, h)
		projectID := h.createTestProject()
...
func TestMCPExecuteRunStopsOnFailure(t *testing.T) {
	eachRemoteMode(t, "ExecRunFailStops", func(t *testing.T, h *mcpHarness) {
		requireRemote(t, h)
		projectID := h.createTestProject()
...
func TestMCPExecuteRunMaxTasksCap(t *testing.T) {
	eachRemoteMode(t, "ExecRunMaxCap", func(t *testing.T, h *mcpHarness) {
		requireRemote(t, h)
		projectID := h.createTestProject()
...
func TestMCPExecuteRunNonexistentRun(t *testing.T) {
	eachRemoteMode(t, "ExecRunBogus", func(t *testing.T, h *mcpHarness) {
		projectID := h.createTestProject()
...
func TestMCPExecuteRunEmpty(t *testing.T) {
	eachRemoteMode(t, "ExecRunIdle", func(t *testing.T, h *mcpHarness) {
		projectID := h.createTestProject()
...
func TestMCPExecuteRunStopsOnGitFailure(t *testing.T) {
	eachRemoteMode(t, "ExecRunGitFail", func(t *testing.T, h *mcpHarness) {
		requireRemote(t, h)
		projectID := h.createTestProject()
...
func TestMCPExecuteRunParallelDrainsAllCompute(t *testing.T) {
	eachRemoteMode(t, "ExecRunParallelAll", func(t *testing.T, h *mcpHarness) {
		requireRemote(t, h)
		projectID := h.createTestProject()
...
func TestMCPExecuteRunParallelStopsAtCitizenWithInflightDrain(t *testing.T) {
	eachRemoteMode(t, "ExecRunParallelStopAtCitizen", func(t *testing.T, h *mcpHarness) {
		requireRemote(t, h)
		projectID := h.createTestProject()
...
func TestMCPExecuteRunParallelRejectsExcessive(t *testing.T) {
	eachRemoteMode(t, "ExecRunParallelCap", func(t *testing.T, h *mcpHarness) {
		requireRemote(t, h)
		projectID := h.createTestProject()
