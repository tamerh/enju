...
var (
	...
	// ErrNotImplemented — placeholder for Ops methods that haven't
	// been ported from v5 to v6 yet during the staged migration.
	// Vanishes when Phase G retires the v5 backend.
	ErrNotImplemented = errors.New("gitv6: not yet implemented")
)
